...
export const TOURNAMENT_WS_MESSAGES = {
	...
	/**
	 * Quit the match for good (the "Leave match" button): removes the player
	 * from the tournament permanently — no reconnection — and frees them to
	 * create/join a new tournament. Distinct from LEAVE, which is reconnectable.
	 */
