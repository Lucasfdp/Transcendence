...
${COMPOSE} exec -T \
    ...
    -e STEAM_CLIENT_ID="${STEAM_CLIENT_ID}" \
    -e STEAM_CLIENT_SECRET="${STEAM_CLIENT_SECRET}" \
    -e XBOX_CLIENT_ID="${XBOX_CLIENT_ID}" \
    -e XBOX_CLIENT_SECRET="${XBOX_CLIENT_SECRET}" \
    -e NINTENDO_CLIENT_ID="${NINTENDO_CLIENT_ID}" \
    -e NINTENDO_CLIENT_SECRET="${NINTENDO_CLIENT_SECRET}" \
    -e PLAYSTATION_CLIENT_ID="${PLAYSTATION_CLIENT_ID}" \
    -e PLAYSTATION_CLIENT_SECRET="${PLAYSTATION_CLIENT_SECRET}" \
    -e CHATGPT_CLIENT_ID="${CHATGPT_CLIENT_ID}" \
    -e CHATGPT_CLIENT_SECRET="${CHATGPT_CLIENT_SECRET}" \
    -e CLAUDE_CLIENT_ID="${CLAUDE_CLIENT_ID}" \
    -e CLAUDE_CLIENT_SECRET="${CLAUDE_CLIENT_SECRET}" \
    -e DEEPSEEK_CLIENT_ID="${DEEPSEEK_CLIENT_ID}" \
    ...
    vault sh -lc '
        ...
        vault kv put kv/transcendence/dev/backend \
            ...
            NINTENDO_CLIENT_ID="$NINTENDO_CLIENT_ID" \
            NINTENDO_CLIENT_SECRET="$NINTENDO_CLIENT_SECRET" \
            ...
            DEEPSEEK_CLIENT_ID="$DEEPSEEK_CLIENT_ID" \
