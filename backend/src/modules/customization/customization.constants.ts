...
export const COSMETICS: CosmeticDefinition[] = [
	...
	},
	{
		...
		type: "shell_skin",
		name: "Flame Shell",
		description: "A blazing shell for players who bring heat to every match.",
		price: 200,
		accentColor: 0xe85f2a,
	},
	{
		id: "nebula",
		type: "shell_skin",
		name: "Nebula Shell",
		description: "A cosmic shell with a deep-space glow.",
		price: 200,
		accentColor: 0x6446d9,
	},
	{
		id: "tribal",
		type: "shell_skin",
		name: "Tribal Shell",
		description: "A marked shell with bold ceremonial patterns.",
		price: 200,
		accentColor: 0xb06b35,
	},
	{
		id: "rune",
		type: "shell_skin",
		name: "Rune Shell",
		description: "An engraved shell carrying ancient dojo glyphs.",
		price: 200,
		accentColor: 0x3d9bb5,
	},
	{
		id: "night_bg",
		type: "hub_background",
	...
	},
	{
		...
		description: "Animated alter art for the dusk dojo background.",
		price: 999,
	...
	},
	{
		...
		description: "Animated alter art for the morning dojo background.",
		price: 999,
		accentColor: 0xf0a24b,
	...
	},
	{
		...
		description: "Animated alter art for the Shell Smash login gate background.",
		price: 999,
		accentColor: 0x2f5f7f,
		previewColor: 0xd7f1ff,
	},
