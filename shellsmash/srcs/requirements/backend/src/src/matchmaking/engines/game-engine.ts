...
import { GameInputPayload, GameSnapshot, MatchRoom, RoomPlayer, SocketUser } from '../matchmaking.types';
...
export interface GameEngine {
  ...
  createInitialState(context: GameEngineCreateContext, roomPlayers: RoomPlayer[]): GameSnapshot;
