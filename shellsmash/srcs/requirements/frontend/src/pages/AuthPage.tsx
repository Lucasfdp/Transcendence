...
import { api, AuthError, NetworkError } from '../hub/api';
    ...
    try {
      ...
      if (err instanceof AuthError) {
        if (err.status === 401 || err.status === 403) {
          setError('Invalid credentials or missing session permissions.');
      ...
      <section className="auth-page__shell">
        <div className="auth-page__intro">
          ...
          <p className="auth-page__description">
            Access the courtyard first. Once your session is active, the main menu will be unlocked.
          </p>
        </div>
